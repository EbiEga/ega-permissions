...
import uk.ac.ebi.ega.permissions.cache.aop.RedisCacheAspect;
...
public class CacheConfig {
    ...
    @Bean
    public RedisCacheAspect redisCacheAspect(final PermissionsDataService permissionsDataService,
